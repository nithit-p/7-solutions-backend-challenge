...
type BeefServiceClient interface {
	GetBeefSummary(ctx context.Context, in *BeefSummaryRequest, opts ...grpc.CallOption) (*BeefSummary, error)
}
...
func (c *beefServiceClient) GetBeefSummary(ctx context.Context, in *BeefSummaryRequest, opts ...grpc.CallOption) (*BeefSummary, error) {
	out := new(BeefSummary)
	err := c.cc.Invoke(ctx, "/beef.BeefService/GetBeefSummary", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BeefServiceServer interface {
	GetBeefSummary(context.Context, *BeefSummaryRequest) (*BeefSummary, error)
...
func (UnimplementedBeefServiceServer) GetBeefSummary(context.Context, *BeefSummaryRequest) (*BeefSummary, error) {
...
func _BeefService_GetBeefSummary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/beef.BeefService/GetBeefSummary",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BeefServiceServer).GetBeefSummary(ctx, req.(*BeefSummaryRequest))
	}
